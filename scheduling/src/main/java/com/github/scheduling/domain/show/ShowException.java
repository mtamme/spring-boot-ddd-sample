...
public class ShowException extends ProblemException {
  ...
  public static final Problem OVERLAP_PROBLEM = Problem.invariant("show-overlap", "Hall already has a show at this time");
  public static final Problem PAST_SCHEDULE_PROBLEM = Problem.invariant("show-past-schedule", "Cannot schedule a show in the past");
