...
- For multiple‑choice questions:
  ...
  - Present your **recommended option prominently** at the top with clear reasoning (1-2 sentences explaining why this
    is the best choice).
...
- Then immediately apply the clarification to the most appropriate section(s):
  ...
  - Non-functional constraint → Add/modify measurable criteria in Non-Functional / Quality Attributes section (convert
