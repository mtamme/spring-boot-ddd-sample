...
class ArchitectureTest {
  ...
  void coreLayerMustOnlyDependOnApprovedPackages(final JavaClasses classes) {
    ArchRuleDefinition.classes()
      ...
      .should().onlyDependOnClassesThat().resideInAnyPackage(
        "java..",
        CORE_PACKAGE)
      .because("the core layer must stay technology-agnostic, it may depend only on explicitly approved packages to prevent leaking infrastructure concerns into it")
      .check(classes);
  }
  ...
  void entitiesMustResideInDomainLayer(final JavaClasses classes) {
    ArchRuleDefinition.classes()
      ...
      .because("entities represent domain concepts and must not be defined outside the domain layer")
      .check(classes);
  }
  ...
  void valueObjectsMustResideInDomainLayer(final JavaClasses classes) {
    ArchRuleDefinition.classes()
      ...
      .because("value objects represent domain concepts and must not be defined outside the domain layer")
      .check(classes);
  }
  ...
  void eventsMustResideInDomainLayer(final JavaClasses classes) {
    ArchRuleDefinition.classes()
      ...
      .because("events represent domain facts and must not be defined outside the domain layer")
      .check(classes);
  }
}
