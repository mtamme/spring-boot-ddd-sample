...
public class OutboxProcessorTest {
  ...
  void runWithNoActiveMessagesShouldDoNothing() {
    ...
    Mockito.when(messageConsumer.lockAllNextActive(Mockito.any(), Mockito.anyInt()))
      .thenReturn(List.of());
    ...
    Mockito.verify(messageConsumer, Mockito.times(1))
      .lockAllNextActive(Mockito.eq(UUID.fromString("00000000-0000-0000-0000-000000000000")), Mockito.eq(100));
