...
public class OutboxProcessorTest {
  ...
  @Test
  void runWithDeliverableMessagesShouldProcessMessagesGroupedAndOrdered() {
    // Arrange
    final var messageConsumer = Mockito.mock(MessageConsumer.class);
  ...
  @Test
  void runWithDeliverableMessagesAndFailureShouldProcessMessagesGroupedAndOrderedUntilFailure() {
    // Arrange
    final var messageConsumer = Mockito.mock(MessageConsumer.class);
