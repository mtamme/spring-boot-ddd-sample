...
class JpaMessageConsumerTest extends PersistenceTest {
  ...
  void countWithNoMessagesShouldReturnMessageCounts() {
    ...
    assertEquals(0, messageCounts.activeLockedCount());
    assertEquals(0, messageCounts.failedCount());
    assertEquals(0, messageCounts.failedLockedCount());
  ...
  @Test
  void countWithActiveLockedMessageShouldReturnMessageCountsWithActiveLockedCount() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.enqueue(Messages.newMessage(
        "A",
    ...
    assertNotNull(messageCounts);
    assertEquals(0, messageCounts.activeCount());
    assertEquals(1, messageCounts.activeLockedCount());
    assertEquals(0, messageCounts.failedCount());
    assertEquals(0, messageCounts.failedLockedCount());
    assertEquals(1, messageCounts.totalCount());
  }
  ...
  @Test
  void countWithFailedLockedMessageShouldReturnMessageCountsWithFailedLockedCount() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.enqueue(Messages.newMessage(
        "A",
    ...
    assertEquals(0, messageCounts.activeLockedCount());
    assertEquals(0, messageCounts.failedCount());
    assertEquals(1, messageCounts.failedLockedCount());
    assertEquals(1, messageCounts.totalCount());
  }
  ...
  @Test
  void requeueLockedWithActiveMessageShouldThrowMessageNotFoundException() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.enqueue(Messages.newMessage(
        "A",
  ...
  @Test
  void requeueLockedWithFailedMessageShouldThrowMessageNotFoundException() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.enqueue(Messages.newMessage(
        "A",
  ...
  @Test
  void requeueAllLockedWithActiveMessagesShouldThrowMessageNotFoundException() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.enqueue(Messages.newMessage(
        "A",
  ...
  @Test
  void requeueAllLockedWithFailedMessagesShouldThrowMessageNotFoundException() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.enqueue(Messages.newMessage(
        "A",
  ...
  @Test
  void dequeueLockedWithActiveMessageShouldThrowMessageNotFoundException() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.enqueue(Messages.newMessage(
        "A",
  ...
  @Test
  void dequeueLockedWithFailedMessageShouldThrowMessageNotFoundException() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.enqueue(Messages.newMessage(
        "A",
  ...
  @Test
  void dequeueAllLockedWithActiveMessagesShouldThrowMessageNotFoundException() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.enqueue(Messages.newMessage(
        "A",
  ...
  @Test
  void dequeueAllLockedWithFailedMessagesShouldThrowMessageNotFoundException() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.enqueue(Messages.newMessage(
        "A",
