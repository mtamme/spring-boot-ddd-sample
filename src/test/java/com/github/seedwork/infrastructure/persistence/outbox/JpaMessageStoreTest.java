...
class JpaMessageStoreTest extends PersistenceTest {
  ...
  @Test
  void countShouldReturnTotalMessageCount() {
    // Arrange
  ...
  @Test
  void countWithMaxRequeueCountShouldReturnQueuedMessageCount() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.persist(Messages.newMessage(
        "00000000-0000-0000-0000-000000000001",
  ...
  @Test
  void countWithMinRequeueCountShouldReturnPoisonMessageCount() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.persist(Messages.newMessage(
        "00000000-0000-0000-0000-000000000001",
  ...
  @Test
  void peekWithUnknownMessageIdShouldThrowMessageNotFoundException() {
    // Arrange
    final var clock = Mockito.mock(Clock.class);
    final var messageStore = new JpaMessageStore(clock, messageRepository);
  ...
  @Test
  void peekAllWithMaxRequeueCountShouldReturnQueuedMessages() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.persist(Messages.newMessage(
        "00000000-0000-0000-0000-000000000001",
  ...
  @Test
  void peekAllWithMinRequeueCountShouldReturnPoisonMessages() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.persist(Messages.newMessage(
        "00000000-0000-0000-0000-000000000001",
  ...
  @Test
  void dequeueShouldDequeueMessage() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.persist(Messages.newMessage(
        "00000000-0000-0000-0000-000000000001",
  ...
  @Test
  void dequeueWithUnknownMessageIdShouldThrowMessageNotFoundException() {
    // Arrange
    final var clock = Mockito.mock(Clock.class);
    final var messageStore = new JpaMessageStore(clock, messageRepository);
  ...
  @Test
  void enqueueShouldEnqueueMessage() {
    // Arrange
    final var clock = Mockito.mock(Clock.class);
  ...
  @Test
  void requeueShouldRequeueMessage() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.persist(Messages.newMessage(
        "00000000-0000-0000-0000-000000000001",
  ...
  @Test
  void requeueWithUnknownMessageIdShouldThrowMessageNotFoundException() {
    // Arrange
    final var clock = Mockito.mock(Clock.class);
  ...
  @Test
  void requeueWithRequeueDelayShouldRequeueMessage() {
    // Arrange
    transactionTemplate.executeWithoutResult(ts -> {
      messageRepository.persist(Messages.newMessage(
        "00000000-0000-0000-0000-000000000001",
  ...
  @Test
  void requeueWithRequeueDelayAndUnknownMessageIdShouldThrowMessageNotFoundException() {
    // Arrange
    final var clock = Mockito.mock(Clock.class);
    final var messageStore = new JpaMessageStore(clock, messageRepository);
