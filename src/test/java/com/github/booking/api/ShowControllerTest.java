...
class ShowControllerTest extends ControllerTest {
  ...
  void getShowShouldReturnGetShowResponse() {
    // Arrange
    Mockito.when(showQueryHandler.getShow("40000000000"))
      .thenReturn(new ShowDetailView(
        "40000000000",
        Instant.EPOCH,
        new ShowMovieView("30000000000", "TestTitle"),
        new ShowHallView("20000000000", "TestName"),
        List.of(new SeatView(
          "A1",
          "RESERVED",
          new SeatBookingView(
            "10000000000",
