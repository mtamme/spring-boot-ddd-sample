...
class ShowTest {
  ...
  void newShowShouldReturnShowWithSeats() {
    ...
    final var show = new Show(
      ...
      Instant.EPOCH,
      Movies.newMovie("M00000000000000000"),
      Halls.newHall("H00000000000000000"));
  ...
  void reserveSeatWithAvailableSeatAndInitiatedBookingShouldReserveSeatAndRaiseSeatReservedEvent() {
    // Arrange
    final var show = Shows.newShow("S00000000000000000");
    final var booking = Bookings.newInitiatedBooking("S00000000000000000", "B00000000000000000");
  ...
  void reserveSeatWithAvailableSeatAndConfirmedBookingShouldThrowSeatException() {
    // Arrange
    final var show = Shows.newShow("S00000000000000000");
    final var booking = Bookings.newConfirmedBooking("S00000000000000000", "B00000000000000000");
  ...
  void reserveSeatWithAvailableSeatAndCancelledBookingShouldThrowSeatException() {
    // Arrange
    final var show = Shows.newShow("S00000000000000000");
    final var booking = Bookings.newCancelledBooking("S00000000000000000", "B00000000000000000");
  ...
  void reserveSeatWithReservedSeatAndInitiatedBookingShouldDoNothingAndRaiseNoEvent() {
    // Arrange
    final var show = Shows.newShowWithReservedSeats("S00000000000000000", "B00000000000000000", "A1");
    final var booking = Bookings.newInitiatedBooking("S00000000000000000", "B00000000000000000");
  ...
  void reserveSeatWithReservedSeatAndUnassignedBookingShouldThrowSeatException() {
    // Arrange
    final var show = Shows.newShowWithReservedSeats("S00000000000000000", "B00000000000000000", "A1");
    final var booking = Bookings.newInitiatedBooking("S00000000000000000", "B00000000000000001");
  ...
  void reserveSeatWithBookedSeatAndInitiatedBookingShouldThrowSeatException() {
    // Arrange
    final var show = Shows.newShowWithBookedSeats("S00000000000000000", "B00000000000000000", "A1");
    final var booking = Bookings.newInitiatedBooking("S00000000000000000", "B00000000000000000");
  ...
  void bookSeatsWithReservedSeatsAndInitiatedBookingShouldBookSeatsAndRaiseSeatBookedEvents() {
    // Arrange
    final var show = Shows.newShowWithReservedSeats("S00000000000000000", "B00000000000000000", "A1", "A2");
    final var booking = Bookings.newInitiatedBooking("S00000000000000000", "B00000000000000000");
  ...
  void bookSeatsWithBookedSeatsAndInitiatedBookingShouldDoNothingAndRaiseNoEvent() {
    // Arrange
    final var show = Shows.newShowWithBookedSeats("S00000000000000000", "B00000000000000000", "A1", "A2");
    final var booking = Bookings.newInitiatedBooking("S00000000000000000", "B00000000000000000");
