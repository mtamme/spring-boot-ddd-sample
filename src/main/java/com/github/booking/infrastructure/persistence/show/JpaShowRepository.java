...
public interface JpaShowRepository extends Repository<Show, Long>, JpaAggregateRepository<Show>, ShowRepository {

  @NativeQuery(name = "ShowDetailView.find")
  Optional<ShowDetailView> find(@Param("show_id") String showId);

  @NativeQuery(name = "ShowDetailView.findAllSeats")
