...
public interface JpaTicketRepository extends Repository<Ticket, Long>, JpaAggregateRepository<Ticket>, TicketRepository {

  @NativeQuery(name = "TicketDetailView.find")
  Optional<TicketDetailView> find(@Param("ticket_id") String ticketId);

  @NativeQuery(name = "TicketSummaryView.findAll")
  List<TicketSummaryView> findAll(@Param("offset") long offset,
