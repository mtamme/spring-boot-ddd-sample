...
public class Seat implements Entity {
  ...
  private void markAsReserved(final BookingId bookingId) {
    ...
    show().raiseEvent(new SeatReserved(showId(), seatNumber(), bookingId()));
  }
  ...
  private void markAsBooked() {
    ...
    show().raiseEvent(new SeatBooked(showId(), seatNumber(), bookingId()));
  }
  ...
  private void markAsAvailable() {
    ...
    show().raiseEvent(new SeatReleased(showId(), seatNumber()));
  }
