package com.github.booking.application.ticket.policy;
...
class IssueTicketWhenSeatBookedTest {
  ...
  void handleShouldIssueTicket() {
    ...
    final var handler = new IssueTicketWhenSeatBooked(ticketRepository, showRepository);
