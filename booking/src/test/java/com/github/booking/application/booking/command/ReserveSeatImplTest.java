...
class ReserveSeatImplTest {
  ...
  @Test
  void handleWithInitiatedBookingShouldReserveSeat() {
    // Arrange
    ...
    final var handler = new ReserveSeatImpl(bookingRepository, showRepository);
    final var command = new ReserveSeat.Command("B00000000000000000", "A1");
