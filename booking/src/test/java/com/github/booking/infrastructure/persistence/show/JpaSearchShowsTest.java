...
class JpaSearchShowsTest extends PersistenceTest {
  ...
  void handleShouldReturnShows() {
    ...
    final var handler = new JpaSearchShows(showRepository);
    final var query = new SearchShows.Query("test title", 0L, 1);
