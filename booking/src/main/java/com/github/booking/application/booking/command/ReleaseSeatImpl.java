...
@Service
class ReleaseSeatImpl implements ReleaseSeat {

  private final BookingRepository bookingRepository;
  private final ShowRepository showRepository;

  public ReleaseSeatImpl(final BookingRepository bookingRepository, final ShowRepository showRepository) {
  ...
  public void handle(final Command command) {
    ...
    show.releaseSeat(booking.bookingId(), new SeatNumber(command.seatNumber()));
