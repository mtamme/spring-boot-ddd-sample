...
public class SeatException extends ProblemException {
  ...
  public static final Problem NOT_BOOKABLE_PROBLEM = Problem.invariant("seat-not-bookable", "Seat not bookable");
  public static final Problem NOT_RELEASABLE_PROBLEM = Problem.invariant("seat-not-releasable", "Seat not releasable");
  public static final Problem NOT_RESERVABLE_PROBLEM = Problem.invariant("seat-not-reservable", "Seat not reservable");
  ...
  public static SeatException notReleasable() {
    return new SeatException(NOT_RELEASABLE_PROBLEM);
  }
